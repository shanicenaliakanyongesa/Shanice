...
#connecting to our database with our upload.html
    ...
    data=(product_name,product_desc,product_cost,product_category,product_image_name.filename)sql="insert into products(product_name,product_desc,product_cost,product_category,product_image_name)"
try:
    ...
    connection.rollback()
    render_template('upload.html', message='Failed Try Again Later')    
else:
